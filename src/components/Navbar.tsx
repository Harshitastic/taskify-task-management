...
import { LogOut, User as UserIcon, Layers, Moon, Sun } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-40 w-full bg-white dark:bg-[#0d0e12] border-b border-slate-200 dark:border-slate-800 py-2.5 px-4 sm:px-6 flex items-center justify-between shadow-sm">
